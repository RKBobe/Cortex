...
SOURCE_CODE_EXTENSIONS = [
    ...
    '.rs', '.go', '.php', '.rb', '.swift', '.kt', '.scala', '.md'
]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ingest a codebase into the AI context model.")
    parser.add_argument("--path", required=True, help="The local path to the code repository.")
    parser.add_argument("--topic", required=True, help="The topic name to associate with this codebase.")
